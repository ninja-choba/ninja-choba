...
const MY_SUPABASE_URL = normalizeSupabaseUrl(process.env.SUPABASE_URL || process.env.MY_SUPABASE_URL);
const SUPABASE_ANON_KEY = process.env.SUPABASE_ANON_KEY;

// 環境変数に入った値のゆらぎを吸収する。
// 前後の空白や改行、末尾のスラッシュ、https:// の付け忘れがあると
// fetch が「Invalid URL string.」で落ち、ログインが一切通らなくなるため。
