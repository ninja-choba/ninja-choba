...
//
// 【2026-09-22 事業版を680円から380円へ値下げ】
// 同じ商品（prod_UgtagE3fTfibik）のまま、Stripe側で380円・3,800円の新しいPriceを
// 作成し、旧680円・6,800円のPriceはアーカイブ済み。getPriceId()はamountを見ず
// 商品ID+intervalだけで価格を解決するため、このファイルのamountはあくまで
// 表示・記録用のラベルであり、実際に請求される金額はStripe側のPrice設定が決める。
//
// 【2026-09-22 不動産版を廃止】
// アプリ本体から不動産管理機能を削除し、契約者がいないことも確認済みのため、
// 新規チェックアウトの選択肢からrealestate/realestate_yearlyを削除した。
// 商品（prod_UgthPJPtr3im61）自体はStripe側で引き続きアーカイブしておくこと
const PLANS = {
  pro: {
    name: '忍者帳場 事業版',
    product_id: 'prod_UgtagE3fTfibik', // 旧ひとり版の商品（現在は380円のPriceが有効）
    amount: 380,
    interval: 'month',
  },
  ...
  pro_yearly: {
    name: '忍者帳場 事業版（年払い）',
    product_id: 'prod_UgtagE3fTfibik', // 旧ひとり版の商品（現在は3,800円のPriceが有効）
    amount: 3800,
    interval: 'year',
  },
